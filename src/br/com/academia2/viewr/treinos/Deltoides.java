 ...
 * @author ANTONIO RONY
 */
public class Deltoides extends javax.swing.JDialog {
private  DefaultTableModel tmResultSet = new DefaultTableModel(null, new String[]{"ID","EXCERCICIO"});;
  java.util.List<br.com.academia2.model.Deltoides> resultado;  
      private ListSelectionModel lsmResult;
      private DefaultTableModel tabela;
      private int idDescricaoControle;
    /**
     * Creates new form Deltoides
     */
    public Deltoides(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    int confirma = JOptionPane.showConfirmDialog(this, "Realmente Deseja ALTERAR?");       // TODO add your handling code here:;
        if (confirma==0) {
            editar();
        }
    ...
    int confirma = JOptionPane.showConfirmDialog(this, "Realmente Deseja EXCLUIR?");       // TODO add your handling code here:;
        if (confirma==0) {
            excluir();
        }        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deltoides.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Deltoides dialog = new Deltoides(new javax.swing.JFrame(), true);
...
private void salvar() {
        br.com.academia2.model.Deltoides model = new br.com.academia2.model.Deltoides();
