 ...
 * @author ANTONIO RONY
 */
public class Coxa extends javax.swing.JDialog {
private  DefaultTableModel tmResultSet = new DefaultTableModel(null, new String[]{"ID","EXCERCICIO"});;
  java.util.List<br.com.academia2.model.Coxa> resultado;  
      private ListSelectionModel lsmResult;
      private DefaultTableModel tabela;
      private int idDescricaoControle;
    /**
     * Creates new form Coxa
     */
    public Coxa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Coxa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Coxa dialog = new Coxa(new javax.swing.JFrame(), true);
...
private void salvar() {
        br.com.academia2.model.Coxa model = new br.com.academia2.model.Coxa();
    ...
    private void buscar() {
       tabela = (DefaultTableModel)jTable1.getModel();
        ...
        Transaction tx = null;
        Criteria crit = sesion.createCriteria(br.com.academia2.model.Coxa.class);
