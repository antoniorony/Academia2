...
import br.com.academia2.model.Modeloantebraco;
import br.com.academia2.model.Modelobiceps;
 ...
 * @author anton
 */
public class ModeloBiceps extends javax.swing.JDialog {
    ...
    ;
  java.util.List<br.com.academia2.model.Modeloantebraco> resultado;
...
//---------------------
    /**
     * Creates new form ModeloBiceps
     */
    public ModeloBiceps(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setToolTipText("ESPAÇO - PARA BUSCAR O TRINO  ||  F1 - PARA CADASTRAR O TREINO");
        ...
        setSize(new java.awt.Dimension(542, 466));
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloBiceps.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModeloBiceps dialog = new ModeloBiceps(new javax.swing.JFrame(), true);
...
crit = sesion.createCriteria(br.com.academia2.model.Antebraco.class
);
        crit.add(Restrictions.like("descricao", text + "%"));
        java.util.List results = crit.list();
        for (Iterator iterator = results.iterator(); iterator.hasNext();) {
            br.com.academia2.model.Antebraco Sal = (br.com.academia2.model.Antebraco) iterator.next();
    ...
    private void salvar() {
        ...
        Modelobiceps modelo = new Modelobiceps();
        modelo.setCadencia(cadencia.getText());
        modelo.setCarga(Integer.parseInt(carga.getText()));
        modelo.setDivt(divt.getText());
        modelo.setIdBiceps(cod);
...
//limpar campos
    ...
    public void passaParametro(int id){
        buscar2(id);
    }
     private void buscar2(int id) {
        tabela = (DefaultTableModel) jTable1.getModel();
        tabela.setNumRows(0);
        Session sesion = HibernateUtil.getSessionFactory().openSession();
        Transaction tx = null;
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modelobiceps.id, modelobiceps.idBiceps, modelobiceps.divt, modelobiceps.serie, modelobiceps.rept, modelobiceps.carga,"
                + " modelobiceps.intponto, modelobiceps.cadencia,  biceps.descricao  from modelobiceps inner join biceps on modelobiceps.idBiceps = biceps.id and modelobiceps.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
