...
import br.com.academia2.model.Modelogluteo;
 ...
 * @author anton
 */
public class ModeloPeitorais extends javax.swing.JDialog {
    ...
    ;
  java.util.List<br.com.academia2.model.Modelopeitorais> resultado;
...
//---------------------
    ...
    /**
     * Creates new form ModeloPeitorais
     */
    public ModeloPeitorais(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
salvar();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloPeitorais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModeloPeitorais dialog = new ModeloPeitorais(new javax.swing.JFrame(), true);
...
private void pesquisaSelecionada(String text) {
        ...
        Criteria crit = sesion.createCriteria(br.com.academia2.model.Peitorais.class
        );
        crit.add(Restrictions.like("descricao", text + "%"));
        java.util.List results = crit.list();
        for (Iterator iterator = results.iterator(); iterator.hasNext();) {
            br.com.academia2.model.Peitorais Sal = (br.com.academia2.model.Peitorais) iterator.next();
...
//limpar campos
    ...
    public void limparCampos() {
     ...
     private void buscar2(int id) {
        ...
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modelopeitorais.id, modelopeitorais.idPeitorais, modelopeitorais.divt, modelopeitorais.serie, modelopeitorais.rept, modelopeitorais.carga,"
                + " modelopeitorais.intponto, modelopeitorais.cadencia, peitorais.descricao from modelopeitorais inner join peitorais on modelopeitorais.idPeitorais = peitorais.id and modelopeitorais.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
