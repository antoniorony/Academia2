 ...
 * @author anton
 */
public class ModeloDorsais extends javax.swing.JDialog {
    ...
    ;
  java.util.List<br.com.academia2.model.Modelodorsais> resultado;
...
//---------------------
    ...
    /**
     * Creates new form ModeloDorsais
     */
    public ModeloDorsais(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloDorsais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModeloDorsais dialog = new ModeloDorsais(new javax.swing.JFrame(), true);
...
private void pesquisaSelecionada(String text) {
        ...
        Criteria crit = sesion.createCriteria(br.com.academia2.model.Dorsais.class
        );
        crit.add(Restrictions.like("descricao", text + "%"));
        java.util.List results = crit.list();
        for (Iterator iterator = results.iterator(); iterator.hasNext();) {
            br.com.academia2.model.Dorsais Sal = (br.com.academia2.model.Dorsais) iterator.next();
...
//limpar campos
    ...
    public void passaParametro(int id){
     ...
     private void buscar2(int id) {
        ...
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modelodorsais.id, modelodorsais.iddorsais, modelodorsais.divt, modelodorsais.serie, modelodorsais.rept, modelodorsais.carga,"
                + " modelodorsais.intponto, modelodorsais.cadencia, dorsais.descricao from modelodorsais inner join dorsais on modelodorsais.iddorsais = dorsais.id and modelodorsais.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
