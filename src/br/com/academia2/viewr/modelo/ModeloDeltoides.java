...
import br.com.academia2.model.Modelocoxa;
import br.com.academia2.model.Modelodeltoides;
 ...
 * @author anton
 */
public class ModeloDeltoides extends javax.swing.JDialog {
    ...
    ;
  java.util.List<br.com.academia2.model.Modelodeltoides> resultado;
...
//---------------------
    ...
    /**
     * Creates new form ModeloDeltoides
     */
    public ModeloDeltoides(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloDeltoides.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModeloDeltoides dialog = new ModeloDeltoides(new javax.swing.JFrame(), true);
...
private void pesquisaSelecionada(String text) {
        ...
        Criteria crit = sesion.createCriteria(br.com.academia2.model.Deltoides.class
        );
        crit.add(Restrictions.like("descricao", text + "%"));
        java.util.List results = crit.list();
        for (Iterator iterator = results.iterator(); iterator.hasNext();) {
            br.com.academia2.model.Deltoides Sal = (br.com.academia2.model.Deltoides) iterator.next();
...
//limpar campos
    ...
    public void passaParametro(int id){
     ...
     private void buscar2(int id) {
        ...
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modelodeltoides.id, modelodeltoides.iddeltoides, modelodeltoides.divt, modelodeltoides.serie, modelodeltoides.rept, modelodeltoides.carga,"
                + " modelodeltoides.intponto, modelodeltoides.cadencia,  deltoides.descricao  from modelodeltoides inner join deltoides on modelodeltoides.iddeltoides = deltoides.id and modelodeltoides.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
