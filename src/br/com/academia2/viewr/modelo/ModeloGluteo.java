 ...
 * @author anton
 */
public class ModeloGluteo extends javax.swing.JDialog {
    ...
    ;
  java.util.List<br.com.academia2.model.Modelogluteo> resultado;
...
//---------------------
    /**
     * Creates new form ModeloGluteo
     */
    public ModeloGluteo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloGluteo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModeloGluteo dialog = new ModeloGluteo(new javax.swing.JFrame(), true);
...
private void pesquisaSelecionada(String text) {
        ...
        Criteria crit = sesion.createCriteria(br.com.academia2.model.Gluteo.class
        );
        crit.add(Restrictions.like("descricao", text + "%"));
        java.util.List results = crit.list();
        for (Iterator iterator = results.iterator(); iterator.hasNext();) {
            br.com.academia2.model.Gluteo Sal = (br.com.academia2.model.Gluteo) iterator.next();
...
//limpar campos
    ...
    public void passaParametro(int id){
     ...
     private void buscar2(int id) {
        ...
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modelogluteo.id, modelogluteo.idgluteo, modelogluteo.divt, modelogluteo.serie, modelogluteo.rept, modelogluteo.carga,"
                + " modelogluteo.intponto, modelogluteo.cadencia, gluteo.descricao from modelogluteo inner join gluteo on modelogluteo.idgluteo = gluteo.id and modelogluteo.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
