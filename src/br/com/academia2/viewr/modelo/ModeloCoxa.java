 ...
 * @author anton
 */
public class ModeloCoxa extends javax.swing.JDialog {
    ...
    ;
  java.util.List<br.com.academia2.model.Modelocoxa> resultado;
...
//---------------------
    /**
     * Creates new form ModeloCoxa
     */
    public ModeloCoxa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloCoxa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModeloCoxa dialog = new ModeloCoxa(new javax.swing.JFrame(), true);
...
crit = sesion.createCriteria(br.com.academia2.model.Coxa.class
);
        crit.add(Restrictions.like("descricao", text + "%"));
        java.util.List results = crit.list();
        for (Iterator iterator = results.iterator(); iterator.hasNext();) {
            br.com.academia2.model.Coxa Sal = (br.com.academia2.model.Coxa) iterator.next();
...
//limpar campos
    ...
    public void passaParametro(int id){
     ...
     private void buscar2(int id) {
        ...
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modelocoxa.id, modelocoxa.idcoxa, modelocoxa.divt, modelocoxa.serie, modelocoxa.rept, modelocoxa.carga,"
                + " modelocoxa.intponto, modelocoxa.cadencia,  coxa.descricao  from modelocoxa inner join coxa on modelocoxa.idcoxa = coxa.id and modelocoxa.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
