 ...
 * @author ANTONIO RONY
 */
public class ModeloAbdome extends javax.swing.JDialog {
...
//---------------------
    ...
    /**
     * Creates new form ModeloAbdome
     */
    public ModeloAbdome(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("MODELO ABDÔMEN - TECINOVA");
        ...
        setSize(new java.awt.Dimension(564, 459));
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloAbdome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModeloAbdome dialog = new ModeloAbdome(new javax.swing.JFrame(), true);
...
//limpar campos
    ...
    public void passaParametro(int id){
     ...
     private void buscar2(int id) {
        ...
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modeloabdome.id, modeloabdome.idabdome, modeloabdome.divt, modeloabdome.serie, modeloabdome.rept, modeloabdome.carga,"
                + " modeloabdome.intponto, modeloabdome.cadencia,  abdome.descricao  from modeloabdome inner join abdome on modeloabdome.idabdome = abdome.id and modeloabdome.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
