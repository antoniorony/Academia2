...
//limpar campos
    ...
    public void passaParametro(int id){
     ...
     private void buscar2(int id) {
        ...
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modelogemeos.id, modelogemeos.idgemeos, modelogemeos.divt, modelogemeos.serie, modelogemeos.rept, modelogemeos.carga,"
                + " modelogemeos.intponto, modelogemeos.cadencia, gemeos.descricao from modelogemeos inner join gemeos on modelogemeos.idgemeos = gemeos.id and modelogemeos.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
