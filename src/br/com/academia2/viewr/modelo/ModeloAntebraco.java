...
import br.com.academia2.model.Modeloabdome;
 ...
 * @author anton
 */
public class ModeloAntebraco extends javax.swing.JDialog {
...
//---------------------
    ...
    /**
     * Creates new form ModeloAntebraco
     */
    public ModeloAntebraco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloAntebraco.class
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModeloAntebraco dialog = new ModeloAntebraco(new javax.swing.JFrame(), true);
...
//limpar campos
    ...
    public void passaParametro(int id){
     ...
     private void buscar2(int id) {
        ...
        //PESQUISA COM SQLQUERY E JOIN MAIS TRANSFORMACAO EM LISTA DO HIBERNATE.
        SQLQuery query = sesion.createSQLQuery("select modeloantebraco.id, modeloantebraco.idAntebraco, modeloantebraco.divt, modeloantebraco.serie, modeloantebraco.rept, modeloantebraco.carga,"
                + " modeloantebraco.intponto, modeloantebraco.cadencia,  antebraco.descricao  from modeloantebraco inner join antebraco on modeloantebraco.idAntebraco = antebraco.id and modeloantebraco.id = '"+id+"'");
        query.setResultTransformer(Criteria.ALIAS_TO_ENTITY_MAP);
        java.util.List results = query.list();
        for (Object object : results) {
            Map row = (Map) object;
