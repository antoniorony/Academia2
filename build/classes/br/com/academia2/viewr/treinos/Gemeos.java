 ...
 * @author ANTONIO RONY
 */
public class Gemeos extends javax.swing.JDialog {
private  DefaultTableModel tmResultSet = new DefaultTableModel(null, new String[]{"ID","EXCERCICIO"});;
  java.util.List<br.com.academia2.model.Gemeos> resultado;  
      private ListSelectionModel lsmResult;
      private DefaultTableModel tabela;
      private int idDescricaoControle;
    /**
     * Creates new form Gemeos
     */
    public Gemeos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gemeos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Gemeos dialog = new Gemeos(new javax.swing.JFrame(), true);
...
private void salvar() {
        br.com.academia2.model.Gemeos model = new br.com.academia2.model.Gemeos();
        model.setDescricao(b.getText());
    ...
    private void jTTabelaLinhaSelecionada(JTable tabela) {
        if (jTable1.getSelectedRow()!= -1) {     
          ...
          b.setText((jTable1.getValueAt(jTable1.getSelectedRow(),1)).toString());
