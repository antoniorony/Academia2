...
private  DefaultTableModel tmResultSet = new DefaultTableModel(null, new String[]{"ID","EXCERCICIO"});;
  java.util.List<br.com.academia2.model.Abdome> resultado;  
    ...
    private void initComponents() {
        ...
        jTAbdome = new javax.swing.JTextField();
        ...
        jTAbdome.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jTAbdome.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTAbdomeActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jTAbdome, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jTPesq, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
    ...
    private void jTAbdomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTAbdomeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTAbdomeActionPerformed
    ...
    int confirma = JOptionPane.showConfirmDialog(this, "Deseja realmente ALTERAR");
    if(confirma == 0) {
        editar();
    }else{
 ...
 // TODO add your handling code here:
    ...
    private javax.swing.JTextField jTAbdome;
    private javax.swing.JTextField jTPesq;
    private javax.swing.JTable jTable1;
    // End of variables declaration//GEN-END:variables

    private void salvar() {
        br.com.academia2.model.Abdome abdome = new br.com.academia2.model.Abdome();
        abdome.setDescricao(jTAbdome.getText());
    ...
    private void buscar() {
        ...
        Transaction tx = null;
        Criteria crit = sesion.createCriteria(br.com.academia2.model.Abdome.class);
        crit.add(Restrictions.like("descricao", jTPesq.getText() + "%"));
        java.util.List results = crit.list();
        for (Iterator iterator = results.iterator(); iterator.hasNext();) {
            br.com.academia2.model.Abdome Sal = (br.com.academia2.model.Abdome) iterator.next();
    ...
    private void jTTabelaLinhaSelecionada(JTable tabela) {
        if (jTable1.getSelectedRow()!= -1) {     
          ...
          jTAbdome.setText((jTable1.getValueAt(jTable1.getSelectedRow(),1)).toString());
    ...
    private void excluir() {
        br.com.academia2.model.Abdome abdome = new br.com.academia2.model.Abdome();
        abdome.setId(this.idDescricaoControle);
        abdome.setDescricao(jTAbdome.getText());
        Session session = HibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
        session.delete(abdome);
        session.getTransaction().commit();
