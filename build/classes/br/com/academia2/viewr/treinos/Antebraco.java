 ...
 * @author ANTONIO RONY
 */
public class Antebraco extends javax.swing.JDialog {
private  DefaultTableModel tmResultSet = new DefaultTableModel(null, new String[]{"ID","EXCERCICIO"});;
  java.util.List<br.com.academia2.model.Abdome> resultado;  
    ...
    /**
     * Creates new form Antebraco
     */
    public Antebraco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        desabilitados();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setBackground(new Color(0,0,0,1));
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/academia2/icone/pesquisa.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jTPesq, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Antebraco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Antebraco dialog = new Antebraco(new javax.swing.JFrame(), true);
 ...
 private void salvar() {
        br.com.academia2.model.Antebraco antebraco = new br.com.academia2.model.Antebraco();
        antebraco.setDescricao(jTextField1.getText());
        Session session = HibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
        session.save(antebraco);
    ...
    private void buscar() {
       tabela = (DefaultTableModel)jTable1.getModel();
        ...
        Transaction tx = null;
        Criteria crit = sesion.createCriteria(br.com.academia2.model.Antebraco.class);
    ...
    private void excluir() {
        br.com.academia2.model.Antebraco antebraco = new br.com.academia2.model.Antebraco();
        antebraco.setId(this.idDescricaoControle);
        antebraco.setDescricao(jTextField1.getText());
        Session session = HibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
        session.delete(antebraco);
        session.getTransaction().commit();
