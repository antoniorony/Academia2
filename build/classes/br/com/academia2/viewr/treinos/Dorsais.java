 ...
 * @author ANTONIO RONY
 */
public class Dorsais extends javax.swing.JDialog {
private  DefaultTableModel tmResultSet = new DefaultTableModel(null, new String[]{"ID","EXCERCICIO"});;
  java.util.List<br.com.academia2.model.Dorsais> resultado;  
      private ListSelectionModel lsmResult;
      private DefaultTableModel tabela;
      private int idDescricaoControle;
    /**
     * Creates new form Dorsais
     */
    public Dorsais(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dorsais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dorsais dialog = new Dorsais(new javax.swing.JFrame(), true);
...
private void salvar() {
        br.com.academia2.model.Dorsais model = new br.com.academia2.model.Dorsais();
